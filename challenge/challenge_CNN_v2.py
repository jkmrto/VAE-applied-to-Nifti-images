...
W_conv1 = weight_variable([5, 5, 1, 32], name='Wconv1')
b_conv1 = bias_variable([32], name='bconv1')
...
W_conv2 = weight_variable([5, 5, 32, 64], name='Wconv2')
b_conv2 = bias_variable([64], name='bconv2')

h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2, name='relu2') + b_conv2)
h_pool2 = max_pool_2x2(h_conv2, name='pool2')

W_conv3 = weight_variable([5, 5, 64, 128], name='Wconv2')
b_conv3 = bias_variable([128], name='bconv2')
...
#
W_fc1 = weight_variable([finalsize[0] * finalsize[1] * 64, 1024], name='fc1')
