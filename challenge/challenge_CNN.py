...
W_conv1 = weight_variable([5, 5, 1, 16], name='Wconv1')
b_conv1 = bias_variable([16], name='bconv1')
...
W_conv2 = weight_variable([5, 5, 16, 32], name='Wconv2')
b_conv2 = bias_variable([32], name='bconv2')

h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2, name='relu2') + b_conv2)
h_pool2 = max_pool_2x2(h_conv2, name='pool2')

W_conv3 = weight_variable([5, 5, 32, 64], name='Wconv2')
b_conv3 = bias_variable([64], name='bconv2')
...
#
W_fc1 = weight_variable([finalsize[0] * finalsize[1] * 64, 200], name='fc1')
b_fc1 = bias_variable([200], name='bfc1')
#
h_pool2_flat = tf.reshape(h_pool3, [-1, finalsize[0] * finalsize[1] * 64], name='pool2f')
...
#
W_fc2 = weight_variable([200, n_classes])
